...
# This file is generated automatically by Daje Tools 2026-01-29 18:27:28.
# It will be re-created by Daje Tools again and any changes
# will be over written.
#
# <!-- Autogenerated file 2026-01-29 18:27:28 -->
...
sub load_companies_companies_fkey($self, $companies_companies_fkey) {
    return $self->load_fkey(
        $self->table_name, $self->fields(), "mail_companies_fkey", $mail_companies_fkey
    );
}
...
sub load_users_users_fkey($self, $users_users_fkey) {
    return $self->load_fkey(
        $self->table_name, $self->fields(), "mail_users_fkey", $mail_users_fkey
    );
}
